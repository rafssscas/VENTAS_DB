        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (resultado)
                {
                   ...
                   // row.Cells["Stock"].Value = ((OpcionCombo)cbocategoria.SelectedItem).Texto.ToString();
        ...
        private void btnexportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach(DataGridViewRow row in dgvdata.Rows)
                {
                    ...
                    savefile.FileName = string.Format("ReporteProducto_{0}.xlsl", DateTime.Now.ToString("ddMMyyyHHmmss"));
